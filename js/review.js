...
$('#allAnswered').click(function() {
	...
	console.log('now I need to pull this data to check it');
});
...
$('#dateReview').append($('#datepicker').val());
	$('#sectionReview').append();
	$('#areaReview').append();
	$('#preventsReview').append();
	$('#ordsReview').append();
	$('#medsReview').append();
	$('#missigReview').append();
	$('#EvrReview').append();
	$('#aaReview').append();
	$('#rescuesReview').append();
	$('#o2Review').append();
	$('#drowningsReview').append();
	$('#recoveryReview').append();
});

function reviewUserData() {
  firebase.database().ref('dailyActivity').val({
    date: $('#datepicker').val(),
    section: "",//$('#section').attr('value'),  <-----undefined at this point, will define later
    area: "",     //as I enter the values, I will need to update the blank key-value pairs in database
	stats: {
